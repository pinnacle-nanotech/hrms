		...
		locations: [
			{
				...
				title: 'Headquarters',
				html: '<strong>Headquarters</strong> <br> 121 King Street, Melbourne <br> Victoria 3000 Australia <br> abcd Pty Ltd',
				icon: marker
			},
			{
				...
				html: '<strong>Secondary Office</strong> <br> 47 Queen Street, Melbourne <br> Victoria 3000 Australia <br> abcd Pty Ltd',
				icon: marker
			}
		]
	}).Load();
